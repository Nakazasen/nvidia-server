...
export function createWorkspaceCore({
  ...
  const PERMISSION_DEFINITIONS = [
    ...
    { permissionId: 'abw.read', actionType: 'abw.read', riskLevel: 'low', modeAllowed: 'both-readonly', requiresApproval: false, requiresTrustedWorkspace: true, requiresConfirmation: false, description: 'Run read-only ABW CLI bridge commands against the active trusted workspace.', exampleActions: ['POST /proxy/abw/ask', 'POST /proxy/abw/doctor', 'POST /proxy/abw/version'] },
